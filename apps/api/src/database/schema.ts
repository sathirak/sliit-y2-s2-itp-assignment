...
import { orders } from 'src/modules/orders/models/order.model';
...
export { usersTable, tickets, orders, products, contracts, contractRequests, contractRequestComments, userProviders, userProvidersRelations };
